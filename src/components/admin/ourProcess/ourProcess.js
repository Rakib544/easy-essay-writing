...
const OurProcess = () => {
  ...
  const onSubmit = (data) => {
    ...
    fetch(`http://localhost:8080/process/update/${_id}`, {
      method: 'PUT',
    ...
    <>
      ...
      <div className="bg-white py-4 px-5 my-4 box-shadow">
        ...
        <div className="mt-4 mb-4 d-flex justify-content-between align-items-center">
          ...
          <button
            className="btn-style" data-bs-toggle="modal" data-bs-target="#processModal1"
          >
            Edit
          </button>
        </div>
        ...
        <div className="mt-4 mb-3 d-flex justify-content-between align-items-center">
          ...
          <button
            className="btn-style" data-bs-toggle="modal" data-bs-target="#processModal2"
          >
            Edit
          </button>
        </div>
        ...
        <div className="row mt-2">
          {
            processCardsData.map((processCardData, index) => (
              <OurProcessCard processCardData={processCardData} key={processCardData._id} index={index} setNumber={setNumber} number={number} />
            ))
          }
        </div>
      ...
      <div class="modal fade" id="processModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal fade" id="processModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
          <div class="modal-content">
            <div class="modal-header">
