...
const BannerInfo = () => {
    ...
    const onSubmit = (data) => {
        ...
        fetch(`http://localhost:8080/banner/update/${_id}`, {
            method: 'PUT',
        ...
        <>
            ...
            <div className="bg-white py-4 px-5 my-4 box-shadow">
                ...
                <div className="mt-4 mb-4 d-flex justify-content-between align-items-center">
                    ...
                    <button
                        className="btn-style" data-bs-toggle="modal" data-bs-target="#bannerModal1"
                    >
                        Edit
                    </button>
                </div>
                ...
                <div className="mt-4 mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <button
                        className="btn-style" data-bs-toggle="modal" data-bs-target="#bannerModal2"
                    >
                        Edit
                    </button>
                </div>
