    ...
    return (
        <div className='bg-light mt-5 pt-5 mb-5 pb-5 '>
            <div className='container bg-white p-5 ' >
                <div className='row  d-flex justify-content-center align-items-center border-bottom pb-4 mb-3' >
                    ...
                    <div className='col-md-2 d-flex flex-column align-items-center' >
                        ...
                        <button className={`${styles.admin}`} type="">Work in progress</button>
                    </div>
                    <div className='col-md-2 d-flex flex-column align-items-center' >
                        <h4 className='text-primary' >File - Delivery</h4>
                        <button type="button" class="btn btn-primary text-white">Upload file <MdFileUpload className='ms-3' size={28} /></button>
                    </div>
                    <div className='col-md-2 d-flex flex-column align-items-center' >
                        <h4 className='text-primary' >Order-Action</h4>
                        <button type="button" class="btn btn-success text-white px-5 py-2">Complete</button>
                    </div>
                </div>
